...
# print(type(x))
# user input
# au = int(input("Enter first value"))
# bu = int(input("Enter second value"))
# print(au+bu)
...
# # print(s[5])
# # print(s[-4])
# String :  K  O  L  K  A  T  A 
# index  :  0  1  2  3  4  5  6
# index  : -7 -6 -5 -4 -3 -2 -1
# string = 'Kolkata'
# string2 = string+" india"
# print(string2)
# print(len(string))
# print(string[5])
# print(string[0:4])
...
# print(footballer.endswith("ss"))

# ft = footballer[0:len(footballer)-1]
# print(ft)
# print(ft.endswith("ss"))

print(footballer.find("Mes"))

# print(footballer[7:11])
# print(footballer[7:12])
# print(footballer[7:])
# print(len(footballer))
# print(footballer[-5 : ])
# print(footballer.endswith("ss"))
# # print(x.count('k'))
